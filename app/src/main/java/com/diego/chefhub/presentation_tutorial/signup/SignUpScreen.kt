package com.diego.chefhub.presentation_tutorial.signup
...
fun SignUpScreen(auth: FirebaseAuth) {
    ...
    Column(
        ...
        Button(onClick = {
            auth.createUserWithEmailAndPassword(email, passwrod).addOnCompleteListener { task ->
                if (task.isSuccessful) {
                    Log.i("diego", "registro OK")
                } else {
                    Log.i("diego", "registro KO")
                }
            }
        }) {
            Text("Sign Up")
